...
import com.appmobile.service.MobileJpaService;
...
public class MobileController 
{
	...
	@PostMapping("/customer/mobiles/addMobile")
	...
	@GetMapping("/mobiles/{mobileId}/customeer")
	public Customer getMobileCustomer(@PathVariable("mobileId") int mobileId)
	{
		return mobileService.getMobileCustomer(mobileId);
	}
